...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> _getDeviceIdentifier() async {
    ...
    try {
      final result = await platform.invokeMethod('getDeviceIdentifier');
      deviceIdentifier = result;
    } on PlatformException catch (e) {
      deviceIdentifier = "Failed to get device identifier: ${e.message}";
    }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Column(
          children: [
            Text("Device Identifier: $_deviceIdentifier"),
            Expanded(
              child: ListView(
